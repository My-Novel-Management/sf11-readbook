...
def sc_library_lady(w: World):
    ...
    return w.scene("図書館の女性",
            ...
            _.do("中は二階までの吹き抜け構造になっていて、天井には薄っすらと宗教画のようなものが残っている。ただ採光の為の窓が少なく、本棚が多く並ぶ奥の部屋は暗がりに浸かっていた。それでもユーリィは貴重なライトを使い、それらの本棚の一つ一つを確認して回る"),
            _.do("木製の棚ではなかったから、棚そのものが風化しているということはなかった。ただ所蔵されている本は当然紙を原料としたものであり、風雨に晒されて劣化した挙句に、虫による侵食で外観のみを残して中身は空洞化してしまっていた"),
            _.do("手に取るのが躊躇われた。それでも一冊くらいは、と分厚いハードカバーの装丁本を引き抜いてみたが、その途端、砂になった中身が落下した"),
            ...
            yuri.do("入った時に見落としてしまったのだろう。瓦礫の陰に隠れて、展示用のケースが一台、倒れていた"),
            _.do("その中に五冊の本を見つける。ただ、ケースから飛び出ていた四冊は腐食していた。ケースの中に唯一留まっていた一冊だけが、無事なように見えた"),
            _.talk("押収するよ、クド。記録"),
            kudo.talk("了解した"),
            yuri.do("時刻と押収物を犬型ドローンに記録させる"),
            _.do("開いたケースの隙間に手を入れ、かつてペーパーバックと呼ばれていたものだろう、片手で持てる程度のサイズの本を、取った"),
            jas.talk("その本を、借りられますか？"),
            yuri.do("振り返ると、知らない眼鏡の女性が立っていた。言語は英語でもドイツ語でもロシア語ですらない"),
            _.do("ユーリィはクドを見たが、その間に言語特定が終わったようで、彼女が自分にこの本のレンタルを尋ねたのだと理解した"),
            _.do("女性はユーリィとは違いかなり軽装で、脛《すね》が見える程度の長さの赤やオレンジで編み込まれたワンピースに、合皮の袖なしベストを着ていた。肌はミルクチョコレートのようで、後ろでまとめられた髪は艶があり黒い"),
            jas.talk("ところで、当館ではペットの持ち込みは禁じられていますので、申し訳ないのですがそちらの……"),
            yuri.talk("クドです。クドリャフカというのですが、長いのでクドと省略しています。彼はあまり気に入っていないようです"),
            ...
            yuri.talk("ええ。大丈夫です。あなたに襲いかかることは決してありません。それよりも、この本はとても貴重な物です。僕らはそういったものを集めて記録、保管するのが仕事なんです。だから、持っていっても良いでしょうか"),
            _.do("彼女は首を振る"),
            jas.talk("そちらの本には先約があります。その方に貸し出した後でしたら、あなたにお貸しすることも可能ですけど"),
            yuri.do("困った、という表情をユーリィはクドに向けたが、彼は「コードが優先される」と短く告げた"),
            _.explain("コード、というものの存在が、ユーリィたち記録士にとっては絶対だった。それは彼らの業務についての規定であり、彼らを縛り付けているルールでもあり、彼らそのものとも言えた。そこには『現地に人間がいた場合、彼らの言うことを受け入れる必要がある。しかし人間でない場合においてはこの限りでない』と記されている"),
            ...
            jas.talk("はい。彼はこの国を代表する宇宙飛行士です。アンドレ・ヤンと言います"),
            jas.explain("彼女によればアンドレ・ヤンなる人物は一年前に別の国にある打ち上げ基地からロケットで月に向かい、そこに建造されたステーションで様々な任務を十二ヶ月間こなした後、ここに戻ってくるらしい"),
            yuri.talk("分かりました。ではまた明日、訪ねてみます"),
            jas.talk("すみません"),
            yuri.talk("いえ。先約があるのでしたら仕方ない。そうだ。お名前を教えていただけますか？"),
            jas.talk("アンドレ・ヤンです"),
            yuri.talk("いえ、あなたの"),
            jas.talk("私、ですか？　私は……ジャスミン。ジャスミン・チェンです"),
            yuri.talk("僕はユーリィ・コマロフ。ユーリィと気軽に呼んで下さい。それでは"),
            )
