...
def sc_perished_world(w: World):
    ...
    return w.scene("滅びた世界で",
            ...
            yuri.do("アスファルトの割れ目から伸びた樹木の根が放射状に広がり、緑のグラデーションを作る苔がそれらを装飾していた",
                "口元をナノ繊維のマフラーで覆った小柄な男性は、その根元に出来た小さな水たまりを超えようと僅かに屈伸し、跳んだ", "&"),
            ...
            yuri.do("ブーツの足を水たまりから出した彼を嘲笑うかのように合成音声で淡々と尋ねた相棒は、その四肢を広げて木の根に立ち、",
                "ひょい、と効果音を付けたくなる軽快さで水たまりを飛び越えて$Sの一メートル先に着地する", "&"),
...
def sc_old_school(w: World):
    ...
    return w.scene("壊れた学校",
            ...
            kudo.come(),
            yuri.talk("$kudo、学校だよ"),
            kudo.do("何故わざわざ口に出す？　$meのカメラには問題が発生していないから、見れば分かる"),
            ...
            yuri.do("生徒用と思われる玄関前までやってくると、外壁こそ部分的に破損、剥離しているものの、建物の大きな歪みや傾きは計測できない",
            ...
            yuri.do("同じ木製の天板にスチールの曲がった脚が付いた椅子や机が重なって壁に固められている",
                "人為的に綺麗に並べたものではなく、水流のような圧倒的なエネルギぃにより一箇所にまとめられたものだ",
            ...
            yuri.talk("何だい$kudo", "もうエネルギィ切れかい？", "最近燃費性能が落ちているんじゃない？"),
            ...
            yuri.do("思わず声を掛け、現在地での時刻への変換を頼もうとしたが彼は既にドアを開けて階段を降り始めており、",
                    ...
                    "けれど空を見上げても変化のないグレィの分厚い雲が覆い、時折紫色した稲光が縦横に走っているのが確認できるだけだった"),
            w.br(),
            ...
            yuri.do("しばらくの間この学校をベースキャンプとすることに決め、宿直室に戻ってくる",
                    ...
                    "寝る、ということは犬型ドローンに必要ないが、無駄なエネルギぃ消費を抑える為に活動が難しくなる夜の時間帯にはスリープモードにして大人しくしておくのだ",
            ...
            _.do("$Sはベッドに座り、バックパックから一日分のカロリーと栄養素を固めた歯が折れそうなスティックを取り出す",
                    "味はない", "必要最低限のエネルギィ補給用で音を立てて齧りながらゴーグルに小説を呼び出した",
