...
def sc_library_lady(w: World):
    ...
    return w.scene("図書館の女性",
            ...
            yuri.talk("ねえ、あれ"),
            _.do("相変わらず$kudoは答えずに顔だけ向けたが、$Sは指で山の方を差して望遠機能で確認してもらう",
            ...
            _.do("校門だった場所を出て一キロほどひび割れた坂道を進んだところで、巨大な穴が開いていた"),
            yuri.talk("$kudo、お願い"),
            _.do("君はまたそうやって無駄なエネエルギィを使わせるつもりか、等と文句を言うかと思ったが、",
                "$kudoは渋々といった様子で背中を向けて首を下げた",
                "「ありがとう」と伝えてその背に跨る",
                "穴は目測で五メートルほどだが底は見えない",
                "助走をつければ何とか飛べるかも知れないけれど向こう側の地面の強度が不明だ",
                "こういう時は素直に$kudoに頼る"),
            _.do("前足を屈め、力を溜めると、$kudoは一気に穴を飛び越えた"),
            ...
            _.do("何か間違っているのか、と無言の視線を投げかけた$kudoに先に内部の安全を確認するよう促し、",
            ...
            yuri.talk("参ったね"),
            _.do("手に取るのが躊躇われたがそれでも一冊くらいは、",
                "と分厚いハードカバーの装丁本を引き抜いてみた", "途端、砂になった中身が落下して床に小さな山を作る"),
            _.talk("$kudo、ここに本が現存している確率は？"),
            ...
            _.do("その僅かばかりの可能性を求めて壁が崩れているギリギリの箇所まで丁寧に調べて回ったが、水こそ引いているものの、どの本も本としての体裁を死守できていなかった",
                    "全滅だ、と$Sは溜息を落とす"),
            ...
            _.do("$Sは$kudoを見たが、その間に言語特定が終わったようで、彼女が自分にこの本のレンタルを尋ねたのだと理解した"),
            _.do("女性は$Sとは違いかなり軽装で、脛が見える程度の長さの赤やオレンジで編み込まれたワンピースに合皮の袖なしベストを着ていた",
            ...
            _.explain("コード、というものの存在が、$Sたち記録士にとっては絶対だった",
            ...
            camera=w.yuri,
            stage=w.on_library,
            day=w.in_visittown, time=w.at_evening,
            )
